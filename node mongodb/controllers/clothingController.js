...
// Takes you to the clothing catagories page 
router.get('/', (req, res) => {
...
//Shows clothing in their catagories e.g hats, tops
                        ...
                        if (!err) {
                            Listing.find({ product: "clothing" }).distinct('productType', (err, type1) => {
                                if (!err) {
                                    Listing.find({ product: "other" }).distinct('productType', (err, type2) => {
                                        if (!err) {
                                            res.render('clothing/productType', {
                                                product: doc,
                                                user:user,
                                                nav: type,
                                                nav1: type1,
...
// display individual peices of clothing 
